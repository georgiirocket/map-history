...
export const About: React.FC = () => {
    const { scrollMemory } = useAppSelector((state) => state.about)
    const { setScrollMemory } = useActions()
    const { t } = useTranslation()
    const { ref: scrollRef } = useSaveScroll({
        containerName: 'src-content',
        handler: setScrollMemory,
        ...
        <div className="about-container">
            <Card className="rc">
                <div className="cust-area">
                    ...
                    <div ref={scrollRef} className="src-content">
...
function CustomizedAccordions() {
    const { openBox: expanded } = useAppSelector((state) => state.about)
    const { setBox } = useActions()
    const setExpanded = (par: string | false) => setBox(par)
